...
class CTkPaComboBox(CTkBaseClass):
    """
    ...
    def _create_grid(self):
        ...
        left_section_width = self._current_width - self._current_height/1.7
    ...
    def _draw(self, no_color_updates=False):
        ...
        left_section_width = self._current_width/2 - self._current_height/2 #Cambio Paco de self.current_height a lomismo /2
