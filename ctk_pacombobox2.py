...
class CTkPaComboBox2(CTkBaseClass):
    """
    ...
    def _create_grid(self):
        ...
        left_section_width = self._current_width - self._apply_widget_scaling(self._border_width)*2 - self._current_height
        self._entry.grid(row=0, column=0, rowspan=1, columnspan=1, sticky="nsew",
                         padx=self._apply_widget_scaling(self._border_width)+10,
                         #(max(self._apply_widget_scaling(self._corner_radius), self._apply_widget_scaling(3)),
                          #     max(self._apply_widget_scaling(self._current_width - left_section_width + 10), self._apply_widget_scaling(3)+10)),
    ...
    def _draw(self, no_color_updates=False):
        ...
        left_section_width = self._current_width - self._current_height*0 #Cambio Paco de self.current_height a lomismo /2
        ...
        requires_recoloring_2 = self.draw_engine.draw_dropdown_arrow(self._apply_widget_scaling(self._current_width - (self._current_height / 2)/1.7), #he afegit un /1.7 aqui tmb
                                                                     self._apply_widget_scaling(self._current_height / 2),
                                                                     self._apply_widget_scaling(self._current_height / 5)) #HABIA UN 3
